 ...
 * @since AM 5.5.0
 */
public class CollectEntersktOTPPlugin extends AbstractNodeAmPlugin {
	...
	protected Map<String, Iterable<? extends Class<? extends Node>>> getNodesByVersion() {
		return Collections.singletonMap(CollectEntersktOTPPlugin.currentVersion, 
				Collections.singletonList(CollectEntersktOTP.class));
	}
	...
	public String getPluginVersion() {
		return CollectEntersktOTPPlugin.currentVersion;
	}
}
