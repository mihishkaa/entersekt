 ...
 * @since AM 5.5.0
 */
public class GeneratePushNotificationPlugin extends AbstractNodeAmPlugin {
	...
	protected Map<String, Iterable<? extends Class<? extends Node>>> getNodesByVersion() {
		return Collections.singletonMap(GeneratePushNotificationPlugin.currentVersion, 
				Collections.singletonList(GeneratePushNotification.class));
	}
	...
	public String getPluginVersion() {
		return GeneratePushNotificationPlugin.currentVersion;
	}
}
