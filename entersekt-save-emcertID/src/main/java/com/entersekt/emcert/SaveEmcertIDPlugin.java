 ...
 * @since AM 5.5.0
 */
public class SaveEmcertIDPlugin extends AbstractNodeAmPlugin {
	...
	protected Map<String, Iterable<? extends Class<? extends Node>>> getNodesByVersion() {
		return Collections.singletonMap(SaveEmcertIDPlugin.currentVersion, 
				Collections.singletonList(SaveEmcertID.class));
	}
	...
	public String getPluginVersion() {
		return SaveEmcertIDPlugin.currentVersion;
	}
}
