 ...
 * @since AM 5.5.0
 */
public class ValidatePushNotificationPlugin extends AbstractNodeAmPlugin {
	...
	protected Map<String, Iterable<? extends Class<? extends Node>>> getNodesByVersion() {
		return Collections.singletonMap(ValidatePushNotificationPlugin.currentVersion, 
				Collections.singletonList(ValidatePushNotification.class));
	}
	...
	public String getPluginVersion() {
		return ValidatePushNotificationPlugin.currentVersion;
	}
}
