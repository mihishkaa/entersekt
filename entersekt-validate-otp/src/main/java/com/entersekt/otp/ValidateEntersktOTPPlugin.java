 ...
 * @since AM 5.5.0
 */
public class ValidateEntersktOTPPlugin extends AbstractNodeAmPlugin {
	...
	protected Map<String, Iterable<? extends Class<? extends Node>>> getNodesByVersion() {
		return Collections.singletonMap(ValidateEntersktOTPPlugin.currentVersion, 
				Collections.singletonList(ValidateEntersktOTP.class));
	}
	...
	public String getPluginVersion() {
		return ValidateEntersktOTPPlugin.currentVersion;
	}
}
