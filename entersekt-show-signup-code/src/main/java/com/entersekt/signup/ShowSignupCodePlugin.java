 ...
 * @since AM 5.5.0
 */
public class ShowSignupCodePlugin extends AbstractNodeAmPlugin {
	...
	protected Map<String, Iterable<? extends Class<? extends Node>>> getNodesByVersion() {
		return Collections.singletonMap(ShowSignupCodePlugin.currentVersion, 
				Collections.singletonList(ShowSignupCode.class));
	}
	...
	public String getPluginVersion() {
		return ShowSignupCodePlugin.currentVersion;
	}
}
