 ...
 * @since AM 5.5.0
 */
public class FetchEmcertIDPlugin extends AbstractNodeAmPlugin {
	...
	protected Map<String, Iterable<? extends Class<? extends Node>>> getNodesByVersion() {
		return Collections.singletonMap(FetchEmcertIDPlugin.currentVersion, 
				Collections.singletonList(FetchEmcertID.class));
	}
	...
	public String getPluginVersion() {
		return FetchEmcertIDPlugin.currentVersion;
	}
}
